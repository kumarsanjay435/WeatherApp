                    ...
                    Capsule()
                        ...
                        .overlay(
                            TextField("Search for cities", text: $searchText, onCommit:  {
                                self.searchBarVM.searchedQuery = searchText
                            })
...
struct SearchbarView_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            ...
            SearchBarView(expandSearchbar: .constant(true), searchText: .constant(""), searchBarVM: SearchBarViewModel())
        }
